...
},{"./Clock.jsx":2}],2:[function(require,module,exports){
'use strict';
...
var Clock = React.createClass({
  ...
  handleClick: function handleClick(time, text) {
    if (this.state.clockStatus) {
      // If we're counting down (either mode)
      this.stopCountdown();
    } else {
      // If the clock's not counting down
   ...
   */
  countdown: function countdown(time, text) {
   ...
   */
  soundAlarm: function soundAlarm(text) {
   ...
   */
  updateClock: function updateClock(newClockTime) {
    this.setState({
   ...
   */
  formatMilliseconds: function formatMilliseconds(ms) {
    var d = new Date(ms);
...
React.render(React.createElement(App, null), document.getElementById('render-point'));

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"./components/App.jsx":1,"react":159}],4:[function(require,module,exports){
